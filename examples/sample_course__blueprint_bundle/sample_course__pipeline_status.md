...
Use the blueprint and companion artifacts that are present. Treat missing, malformed, or failed components as unresolved evidence; do not infer that absent output means the source course lacked that content.
